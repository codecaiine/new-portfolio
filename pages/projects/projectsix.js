...
const Project = () => (
  <Layout title="Project Six">
    <Container>
      <Title>
        Project Six <Badge>2022</Badge>
      </Title>
      <P>
      ...
      <ProjectImage src="/images/projects/margelo_eyecatch.png" alt="Website" />
      ...
      <ProjectImage src="/images/projects/margelo_01.png" alt="Margelo" />
      <ProjectImage src="/images/projects/margelo_02.png" alt="Margelo" />
      <ProjectImage src="/images/projects/margelo_03.png" alt="Margelo" />
    </Container>
  </Layout>
)
